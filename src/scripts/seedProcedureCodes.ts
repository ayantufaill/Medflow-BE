...
const procedureCodes = [
  ...
  { code: 'D5110', desc: 'Complete denture - maxillary',                                       abbr: 'CD maxillary',          cat: 'Prosthodontics, removable' },
  { code: 'D5120', desc: 'Complete denture - mandibular',                                      abbr: 'CD mandibular',         cat: 'Prosthodontics, removable' },
  ...
  { code: 'D5411', desc: 'Adjust complete denture - mandibular',                               abbr: 'Adjust CD mand',        cat: 'Prosthodontics, removable' },
  { code: 'D5510', desc: 'Repair broken complete denture base',                                abbr: 'Repair CD base',        cat: 'Prosthodontics, removable' },
  { code: 'D5520', desc: 'Replace missing or broken teeth - complete denture',                 abbr: 'Replace tooth CD',      cat: 'Prosthodontics, removable' },

  // ── VII. Maxillofacial Prosthetics (D5900–D5999) ─────────────────────────
  // (placeholder — add specific codes here as needed)

  // ── VIII. Implant Services (D6000–D6199) ─────────────────────────────────
  { code: 'D6010', desc: 'Surgical placement of implant body: endosteal implant',              abbr: 'Implant placement',     cat: 'Implant Services' },
  { code: 'D6056', desc: 'Prefabricated abutment',                                             abbr: 'Prefab abutment',       cat: 'Implant Services' },
  { code: 'D6058', desc: 'Abutment supported porcelain/ceramic crown',                         abbr: 'Implant crown ceramic', cat: 'Implant Services' },
  { code: 'D6065', desc: 'Implant supported porcelain/ceramic crown',                          abbr: 'Implant crown supported',cat: 'Implant Services' },
  { code: 'D6066', desc: 'Implant supported porcelain fused to metal crown',                   abbr: 'Implant crown PFM',     cat: 'Implant Services' },

  // ── IX. Prosthodontics, fixed (D6200–D6999) ──────────────────────────────
  // (placeholder — add specific codes here as needed)

  // ── X. Oral & Maxillofacial Surgery (D7000–D7999) ────────────────────────
  { code: 'D7140', desc: 'Extraction, erupted tooth or exposed root',                          abbr: 'Extraction simple',     cat: 'Oral & Maxillofacial Surgery' },
  { code: 'D7210', desc: 'Extraction, erupted tooth requiring elevation',                      abbr: 'Extraction surgical',   cat: 'Oral & Maxillofacial Surgery' },
