...
export const createPracticeInfoValidator: ValidationChain[] = [
  ...
  body('scheduleConfig.generalSettings').optional().isObject(),
  body('scheduleConfig.generalSettings.enableHorizontalScroll').optional().isBoolean(),
  body('scheduleConfig.generalSettings.minSlotWidth').optional().isNumeric(),
  body('scheduleConfig.generalSettings.showCalendar').optional().isBoolean(),
  body('scheduleConfig.generalSettings.adjustableSlotHeight').optional().isBoolean(),
  body('scheduleConfig.generalSettings.slotHeight').optional().isNumeric(),
  body('scheduleConfig.appointmentCardHeader').optional().isObject(),
  body('scheduleConfig.appointmentCardHeader.patientNameFormat').optional().isString(),
  body('scheduleConfig.appointmentCardHeader.displayAge').optional().isBoolean(),
  body('scheduleConfig.appointmentCardHeader.headerFontColor').optional().isString(),
  body('scheduleConfig.appointmentCardSettings').optional().isObject(),
  body('scheduleConfig.appointmentCardSettings.defaultView').optional().isString(),
  body('scheduleConfig.appointmentCardSettings.infoToDisplay').optional().isArray(),
  body('scheduleConfig.appointmentCardSettings.infoToDisplay.*').optional().isString(),
  body('scheduleConfig.treatmentScheduleSettings').optional().isObject(),
  body('scheduleConfig.treatmentScheduleSettings.providerView').optional().isString(),
  body('scheduleConfig.treatmentScheduleSettings.chairView').optional().isString(),
  body('scheduleConfig.statusColors').optional().isArray(),
  body('scheduleConfig.statusColors.*.name').optional().isString(),
  body('scheduleConfig.statusColors.*.color1').optional().isString(),
  body('scheduleConfig.statusColors.*.color2').optional().isString(),
  body('scheduleConfig.statusColors.*.anim').optional().isString(),
  body('scheduleConfig.appointmentTypes').optional().isArray(),
  body('scheduleConfig.appointmentTypes.*.type').optional().isString(),
  body('scheduleConfig.appointmentTypes.*.providers').optional().isNumeric(),
  body('scheduleConfig.appointmentTypes.*.time').optional().isString(),
